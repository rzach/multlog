...
\author{M.~Ultlog\thanks{Generated from the truth tables of
\NameOfLogic\ logic by
\href{https://github.com/rzach/multlog}{\textsc{multlog}}, v.~@ml_version@.}}
\date{}
...
\FOR \op=1 \TO \NoOps \DO
   {\noindent
    ...
    \begin{center}
       \FOR \tv=1 \TO \NoTVs \DO
          \hspace{2em}%
          \mbox{\infer[{\Opname\op}{\NDEI\tv} \colon {\TV\tv}]
            {\NDOpconcl{\op}{\tv}}
            {\NDOpprems{\op}{\tv}}}%
       \ENDFOR
       \hspace{2em}%
...
\FOR \qu=1 \TO \NoQus \DO
   {\noindent
    ...
    \begin{center}
       \FOR \tv=1 \TO \NoTVs \DO
          \hspace{2em}%
          \mbox{\infer[\Quname\qu\NDEI\tv\colon \TV\tv]{\NDQuconcl{\qu}{\tv}}{\NDQuprems{\qu}{\tv}}}%
       \ENDFOR
       \hspace{2em}%
    \end{center}
   }
