...
\title{Analytic Proof Systems for \ecapitalisewords{\NameOfLogic}\texExtra{ShortName}{~\ShortName}{\relax}}

\author{M.~Ultlog\thanks{Cite as: Multlog (\Year), ``Analytic proof systems for {\NameOfLogic}\texExtra{ShortName}{~\ShortName}{\relax}.'' [PDF file generated
by MULTLOG, v.~@ml_version@, \url{https://logic.at/multlog}].
\texExtra{Link}{Available from \url{\Link}.}{}\newline\newline See
\IfFileExists{\jobname.cfg.stripped}{\cref{lgc,cfg}}{\cref{lgc}} for
the specification of {\NameOfLogic}.}}
...
\NameOfLogic\texExtra{ShortName}{~\ShortName}{\relax}.
\end{abstract}

\section{Introduction}

In this paper we present calculi for
\NameOfLogic{}\texExtra{ShortName}{~\ShortName}{}%
...
\IfFileExists{\jobname.cfg.stripped}{%
  \section{\jobname.cfg~-- \LaTeX\ translations}\label{cfg}
  \lstinputlisting[basicstyle=\footnotesize\ttfamily,breaklines]{\jobname.cfg.stripped}
}{}
