...
\urlstyle{same}
\hypersetup{
  pdftitle={MUltlog 1.17 \& iLC 1.2 User Manual},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{MUltlog 1.17 \& iLC 1.2 User Manual}
\author{}
\date{}
...
\item
  generate the deinstallation script
  \passthrough{\lstinline!ml\_deinstall!}
\item
...
\hypertarget{creating-sequent-rule-files-for-multseq}{%
\section{Creating sequent rule files for
MUltseq}\label{creating-sequent-rule-files-for-multseq}}

The sequent prover \href{https://www.logic.at/multseq}{MUltseq} requires
\passthrough{\lstinline!.msq!} files containing the sequent rules for a
logic. MUltlog can generate such files from logic specification
(\passthrough{\lstinline!.lgc!}) and configuration
(\passthrough{\lstinline!.cfg!}) files. Just say
